...
var playerTwo = 0;
var currentPlayer = "";
var winningSoundSrc = "media/winningsound.wav"
var losingSoundSrc = "media/losing.wav"
...
function finalWinner(setWinner) {
    if (setWinner === "X") {
        ...
        document.getElementById("playerX").value = playerOne
    }
    if (setWinner === "O") {

        playerTwo = playerTwo + 1;
        document.getElementById("playerO").value = playerTwo
    }
}
